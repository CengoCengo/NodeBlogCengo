...
router.post('/edit/:blogId', (req, res) => {
    ...
    Blog.findByIdAndUpdate(req.params.blogId).then((newUpdate)=>{
        
        const title = newUpdate.req.body.data.blogTitle;
        const comSentence = newUpdate.req.body.data.comSentence;
        const comImage = newUpdate.req.body.data.comImage;
        const blog = newUpdate.req.body.data.blog;
